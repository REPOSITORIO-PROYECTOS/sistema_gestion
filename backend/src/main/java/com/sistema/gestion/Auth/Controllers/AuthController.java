...
public class AuthController {
    ...
    public Mono<User> registerUser(
        ...
        switch (userType.toLowerCase()) {
            case "student":
                return authService.registerStudent(userDetails, username);  // Registrar estudiante
            case "teacher":
                return authService.registerTeacher(userDetails, username);  // Registrar profesor
            case "user":
            default:
                return authService.registerUser(userDetails, username);  // Registrar usuario
        }
    }
    ...
    public Mono<User> updateUser(
        ...
        switch (userType.toLowerCase()) {
            case "student":
                return authService.updateStudent(userDetails, username, userId);  // Actualizar estudiante
            case "teacher":
                return authService.updateTeacher(userDetails, username, userId);  // Actualizar profesor
            case "user":
            default:
                return authService.updateUser(userDetails, username, userId);  // Actualizar usuario
        }
    }
    ...
    public Mono<ResponseEntity<Void>> deleteUser(
        ...
        switch (userType.toLowerCase()) {
            case "student":
                return authService.deleteStudent(userId);  // Eliminar estudiante
            case "teacher":
                return authService.deleteTeacher(userId);  // Eliminar profesor
            case "user":
            default:
                return authService.deleteUser(userId);  // Eliminar usuario
        }
    }
