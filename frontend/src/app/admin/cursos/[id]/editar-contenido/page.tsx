...
export default function EditCourseContentPage({
    ...
    useEffect(() => {
        const fetchTeachers = async () => {
            setIsLoading(true);
            try {
                const teachersResponse = await fetch("http://localhost:3030/api/profesores/paged?page=0&size=1000",{
                    method: "GET",
                    headers: {
    ...
    const handleSaveLink = async () => {
        ...
        if (fileForm.id) {
            ...
            const response = await fetch(`http://localhost:3030/api/course-subsections/${activeSubsection}/addFile`, {
                method: "POST",
                headers: {
    ...
    const handleActualizarArchivo = async (file: File | null, fileId: string) => {
        ...
        try{
            ...
            const response = await fetch(
                `http://localhost:3030/api/files/update/${fileId}`,
                {
                    method: "PUT",
                    headers: {
                        Authorization: `Bearer ${user?.token}`,
    ...
    const handleDeleteSection = async (sectionId: string) => {
        ...
        try {
            const response = await fetch(
                `http://localhost:3030/api/course-sections/delete/${sectionId}`,
                {
                    method: "DELETE",
                    headers: {
                        "Content-Type": "application/json",
    ...
    const handleDeleteSubsection = async (subsectionId: string) => {
        ...
        try {
            const response = await fetch(
                `http://localhost:3030/api/course-subsections/delete/${subsectionId}`,
                {
                    method: "DELETE",
                    headers: {
                        "Content-Type": "application/json",
    ...
    const handleDeleteLink = async (linkId: string) => {
        ...
        try {
            const response = await fetch(
                `http://localhost:3030/api/files/delete/${linkId}`,
                {
                    method: "DELETE",
                    headers: {
                        "Content-Type": "application/json",
